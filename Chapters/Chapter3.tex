...
\end{multline}
\begin{equation}
	F_{\mathcal{H}}=\sum_{\mu}\left[\frac{\Omega^{(S)}_{\mu\mathcal{H}}}{2}+Tln\left(1-e^{-\beta\Omega^{(S)}_{\mu\mathcal{H}}}\right)\right],
\end{equation}
where $A_{\mathcal{H}}$ is a normalization constant and $a_{\mu\mathcal{H}}=\sqrt{coth(\beta\Omega^{(S)}_{\mu\mathcal{H}}/2)/(2\Omega^{(S)}_{\mu\mathcal{H}})}$ is called the normal length. $\rho_{\mathcal{H}}(\mathbf{R})$ 
...
is their standard deviation. $\Omega^{(S)}_{\mu}(\mathbf{q})$ and $\epsilon_{s\mu}^{\alpha (S)}(\mathbf{q})$ are the frequencies and polarization vectors that diagonalize the SSCHA dynamical 

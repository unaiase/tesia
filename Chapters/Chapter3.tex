...
For example, let's take the case of spaace group symmetries $S$ and imagine we calculate the 2BFC 
...
In order to have little bit of intuition on how to calculate these quantities, the first-principles calculation of $\epsilon_{\infty}^{\alpha\beta}$ and $Z_{s}^{*\alpha\beta}$ can be started from the definition of the macroscopic electric polarization of the medium, 
\begin{equation}
...
%The third group is the strongly or full anharmonic group where the self-energy is not small compared to the dynamical frequencies. In this case the spectral

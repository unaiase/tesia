...
$ZT_{max}$ of 2, this only happens for very narrow temperature ranges\cite{zhao2014ultralow}. This 
...
carrier concentration. This further decreases the carrier concentration at which the maximum $ZT$ is obtained, but 
does not open any possibility to increase $ZT$. Obviously, apart from the fundamental limitations given by 
correlation, there are practical and technical limitations. \\

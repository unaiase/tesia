...
the the effective charges in the calculation of the harmonic phonons in Fig. \ref{harmonic-volume}. We have seen 
that the effect of the effective charges is negligible in the thermal conductivity. In order to account for the 
effective charges within the SSCHA we include the effective charges in the dynamical matrices after the SSCHA 
minimization.
...
high symmetry positions $0$, $1$, and $0.5$. The new wyckoff position is the 4c wyckoff position of the $Cmcm$ 
...
In Fig. \ref{harmonic-volume} we can see the LDA and PBE phonon spectra in the theoretical and experimental 
structures.
\begin{figure}[th]
\begin{center}
...
measurements for both phases. We do not distinguish between the two in-plane measurement of Wei et al. as the 
difference is difficult to extract from their data. They measure the phase transition at around $800$ K. \\

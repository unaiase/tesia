...
dynamical matrix $\boldsymbol{D}^{(S)}$ as well as the spectra obtained from the SSCHA spectral function. 
\begin{figure*}[ht]
...
\includegraphics[width=0.32\linewidth]{Figures/T2000.eps}
	...
	phonon spectral function (labeled as ``Physical''). Results at 0 K (a), 300 K (b), and 2000 K (c) are shown. 
	(d), (e) and (f) show the frequency divided by the squared momentum. The dispersion corresponds to the 
	$\Gamma$M direction. For 
...
quadratic dispersion become flat. It is noteworthy that the phonon frequencies 
...
With respect to the optical modes, 
\begin{figure}[ht]
\includegraphics[width=0.49\linewidth]{Figures/e2g.eps}
\includegraphics[width=0.49\linewidth]{Figures/e2g.eps}
        \caption[E2g mode temperature dependent frequency shift]{.}
\label{e2g}
\end{figure}
we observe that the frequencies red-shift with increasing temperature in agreement 
with experiments and theory\cite{calizo2007temperature,bonini2007phonon}.  

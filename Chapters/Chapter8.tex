...
\includegraphics[width=0.99\linewidth]{Figures/pressures-graphene.eps}
        \caption[Pressure as a function of the lattice parameter in graphene]{Pressure as a function of the lattice
	parameter calculated with the atomistic potential for different temperatures.}
\label{pressures}
\end{figure}
...
rotationally invariant. Therefore, physical phonons are quadratic because of symmetry. \\

...
(within their error of $0.003$ \AA) at low temperatures. However, at high temperatures they deviate and our 
calculations approach the quantum result as it should be. The difference may be due to the non-trivial calculation of 
the lattice parameter within MD. We have also included the quasiharmonic (QHA) result. The lattice parameter within 
the QHA is calculated by calculating the harmonic free energy for different temperatures and lattice paramters. The 
...
In Fig. \ref{spectrum-graphene} we compare the harmonic phonon spectra with the one obtained from the SSCHA dynamical 
matrix $\boldsymbol{D}^{(S)}$ as well as the spectra obtained from the Hessian of the SSCHA free 
...
\includegraphics[width=0.32\linewidth]{Figures/T2000.eps}
	\caption[Graphene harmonic and anharmonic phonons]{Harmonic phonon spectra together with the SSCHA phonons 
	$\boldsymbol{D}^{(S)}$ (labeled as ``SSCHA'') and those obtained from the Hessian of the SSCHA free energy 
